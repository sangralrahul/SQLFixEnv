"""
SQLFixEnv — Baseline Inference Script
Runs an LLM agent to fix broken SQL queries.
...
def ask_llm(buggy_sql: str, description: str, error_hint: str, schema: str, attempt: int) -> str:
    user_msg = (
        f"Schema:\n{schema}\n\n"
        f"Task:\n{description}\n\n"
        f"Error hint:\n{error_hint}\n\n"
...
def run_task(task_id: str) -> float:
    ...
    for attempt in range(1, MAX_ATTEMPTS + 1):
        ...
        step_resp = env_post("/step", {"session_id": session_id, "fixed_sql": fixed_sql})
